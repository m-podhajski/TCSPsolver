...
public:
    static void test_ll_closed(){
        ...
        TemporalCSPInstance temporalCspInstance(temporalConstraintLanguage, constraints); // R(x_1,x_2,x_3,x_4)^R(x_1,x_2,x_4,x_5)^R(x_1,x_2,x_5,x_3)
    ...
    static void test_min_closed(){
        ...
        TemporalRelation relation(3, {order1, order2, order3, order4}); // R = {(a,b,c) : a>b v a>c}
        ...
        TemporalCSPInstance temporalCspInstance(temporalConstraintLanguage, {constraint1, constraint2}); //R(x_0,x_1,x_1)^R(x_1,x_0,x_0)
    ...
    static void test_mx_closed(){
        ...
        TemporalRelation relation(4, {order1, order2, order3, order4}); // R = {(a,b,c,d) : (a=b^b<c^c=d)v(a=b>c=d)v(a=b^b<c^c<d)v(a>b>c=d)}
        TemporalConstraintLanguage temporalConstraintLanguage({relation});
        ...
        TemporalCSPInstance temporalCspInstance(temporalConstraintLanguage, {constraint1, constraint2}); //R(x_0,x_1,x_2,x_3)^R(x_0,x_1,x_3,x_4)
